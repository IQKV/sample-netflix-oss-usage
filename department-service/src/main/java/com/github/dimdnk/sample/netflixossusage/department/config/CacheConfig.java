...
package com.github.dimdnk.sample.netflixossusage.department.config;

import java.time.Duration;

import com.github.dimdnk.sample.netflixossusage.starter.cache.CacheProperties;
...
class CacheConfig {
  ...
  JCacheManagerCustomizer cacheManagerCustomizer() {
    return cm -> createCache(cm,
        com.github.dimdnk.sample.netflixossusage.department.entity.Department.class.getName()
    );
  }
