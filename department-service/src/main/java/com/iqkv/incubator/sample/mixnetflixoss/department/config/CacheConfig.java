...
import com.iqkv.incubator.sample.mixnetflixoss.starter.cache.CacheProperties;
...
class CacheConfig {
  ...
  JCacheManagerCustomizer cacheManagerCustomizer() {
    return cm -> createCache(cm,
        com.iqkv.incubator.sample.mixnetflixoss.department.entity.Department.class.getName()
    );
  }
